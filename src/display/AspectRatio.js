 ...
 */
function fitContent(content, container, fitMode = FIT_MODE.COVER) {
  ...
  // fit to width / height
  if ((contentRatio < containerRatio && fitMode === FIT_MODE.COVER) || (contentRatio > containerRatio && fitMode === AspectRatio.FIT_MODE.CONTAIN)) {
